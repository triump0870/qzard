...
class TestQuiz(TestCase):
    ...
    def test_quiz_url(self):
        self.assertEqual(self.quiz1.url, 'test-quiz-1')
        self.assertEqual(self.quiz2.url, 'test-quiz-2')
        self.assertEqual(self.quiz3.url, 'test-quiz-3')
        self.assertEqual(self.quiz4.url, 'test-quiz-4')
